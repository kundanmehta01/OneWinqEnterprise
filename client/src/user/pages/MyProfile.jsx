...
export default function MyProfile() {
  ...
  useEffect(() => {
    async function loadData() {
      try {
        const res = await userDashboardService.getDashboardData();
  ...
  const skills = ['React.js', 'TypeScript', 'Tailwind CSS', 'Next.js', 'Redux Toolkit', 'REST APIs', 'UI/UX Prototyping', 'Jest & RTL'];

  const experience = [
    {
      role: 'Software Engineer',
      company: 'Nexisparkx Technologies / OneWinq',
      period: 'Oct 2023 - Present',
      desc: 'Developing enterprise digital identity cards and collaboration platforms using modern React and microfrontends.'
    },
    {
      role: 'Associate Frontend Developer',
      company: 'TechFlow Systems',
      period: 'Jan 2022 - Sep 2023',
      desc: 'Built modular component libraries and customer dashboards. Improved web performance scores by 40%.'
    }
  ];
  ...
  const publicCardUrl = `${window.location.origin}/card/${employee.employeeId || 'owq-alisha'}`;
