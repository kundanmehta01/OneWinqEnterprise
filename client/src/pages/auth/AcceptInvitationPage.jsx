...
export const AcceptInvitationPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Determine accurate destination: Employee / Member -> /user/dashboard; Admin -> /admin/dashboard
      const roleName = meData?.role || (typeof result?.member?.roleId === 'object' ? result.member.roleId?.name : null) || result?.role || 'EMPLOYEE';
      const targetDestination = roleName.toUpperCase().includes('ADMIN') ? '/admin/dashboard' : '/user/dashboard';
