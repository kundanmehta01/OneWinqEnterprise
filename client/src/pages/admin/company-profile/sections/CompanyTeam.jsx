...
export default function CompanyTeam({ members = [] }) {
  ...
  const displayMembers = members.length ? members.slice(0, 8) : ['Founder & CEO', 'Product Manager', 'Frontend Developer', 'UI/UX Designer'].map((designation, index) => ({ _id: designation, name: ['Aarav Mehta', 'Priya Sharma', 'Rohan Kumar', 'Ananya Singh'][index], designation }));
