      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 lg:hidden bg-slate-900/60 backdrop-blur-sm">
            ...
            />
            <aside className="relative ml-auto flex h-full w-[min(86vw,20rem)] flex-col overflow-y-auto bg-white shadow-2xl animate-slideLeft">
              <div className="flex items-center justify-between border-b border-slate-100 p-4">
                <div>
                  <p className="text-sm font-bold text-slate-900">Menu</p>
                  <p className="mt-0.5 text-[10px] text-slate-400">{displayName}</p>
                </div>
                <button
                  type="button"
                  aria-label="Close menu"
              ...
              <div className="flex-1 space-y-1 p-4">
                    ...
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        `flex items-center gap-3 rounded-xl px-3 py-3 text-xs font-medium ${
                          isActive ? 'bg-indigo-600 text-white font-semibold' : 'text-slate-600 hover:bg-slate-50'
                        }`
                      }
                    >
                ...
                {hasAdminPerm && (
                  <NavLink
                    to="/admin"
                    onClick={() => setMobileMenuOpen(false)}
                    className="flex items-center gap-3 rounded-xl bg-purple-50 px-3 py-3 text-xs font-bold text-purple-700"
                  >
              ...
              <div className="border-t border-slate-100 p-4">
                <button onClick={handleLogout} className="flex items-center gap-1.5 text-xs font-semibold text-rose-600">
        ...
        {/* Page Content Viewport */}
        <main className="flex-1 min-h-0 p-4 lg:p-8 pb-24 lg:pb-8 overflow-y-auto">
          <Outlet />
        </main>
