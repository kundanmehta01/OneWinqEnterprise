...
import { Home, User, Plus, FolderGit2, Menu } from 'lucide-react';

export const UserDockNav = ({
  activeScreen = 1,
  onNavigate,
  onToggleMenu,
  menuOpen = false,
  ...
  const dockClasses = isDark
    ...
    : 'flex items-center justify-around bg-white/95 border border-purple-100/80 rounded-full px-3 py-2 shadow-xl shadow-purple-900/10 backdrop-blur-xl ring-1 ring-purple-500/5';
            ...
            return (
              <button
                ...
                className={`relative -top-2.5 w-11 h-11 rounded-full flex items-center justify-center shadow-lg transition-all hover:scale-110 active:scale-95 cursor-pointer ${
                  isDark
                    ? 'bg-gradient-to-r from-purple-600 via-indigo-600 to-purple-700 text-white shadow-purple-500/50 border-2 border-[#0c1229]'
